...
<body>
    <main class="legal-page">
        ...
        <section class="legal-section">
            ...
            <p>
                Ця сторінка містить правила надання послуг, умови оплати, доставки (надання доступу)
                та повернення коштів. Оплата здійснюється через платіжний сервіс WayForPay на сайті
        ...
        <section class="legal-section">
            ...
            <ul>
                <li>разових відвідувань (пакети візитів);</li>
                <li>тимчасових абонементів (доступ на фіксований строк у днях).</li>
            </ul>
            ...
            <ol>
                ...
                <li>Доступ до залу надається після реєстрації візиту через бот (видача шкафчика, облік відвідування).</li>
            </ol>
        ...
        <section class="legal-section">
            <h2>3. Способи оплати та умови «доставки»</h2>
