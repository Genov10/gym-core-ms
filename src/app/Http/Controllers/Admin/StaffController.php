...
class StaffController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.customers.index', [
            ...
            'listMode' => 'staff',
            'listTitle' => 'Персонал',
            'listSubtitle' => 'Сотрудники (is_staff = true)',
            'listBaseUrl' => url('/admin/staff'),
            'emptyLabel' => 'сотрудников',
            'profileBaseUrl' => url('/admin/staff'),
        ]);
    }
    ...
    public function show(Customer $customer)
    {
        ...
        return app(CustomersController::class)->show($customer, listMode: 'staff');
    }
    ...
    private function applyIdentityFilter(Builder $query, string $value): void
    {
        ...
        $query->where(function (Builder $q) use ($value, $pattern, $operator): void {
